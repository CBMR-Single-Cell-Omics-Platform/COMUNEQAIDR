  ...
  fluidPage(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        textInput(inputId = "qc_path", label = "QC Path", value = "scRNAseq/QC"),
        textInput(inputId = "fastq_path", label = "FASTQ Path", value = "scRNAseq/FASTQ"),
        textInput(inputId = "out_path", label = "Out Path", value = "scRNAseq/PipelineOut"),
        textInput(inputId = "log_path", label = "Log Path", value = "scRNAseq/Log"),
